                                    ...
                                    <div class="rounded-xl border border-slate-200 bg-white p-4 lg:col-span-3">
                                        ...
                                        <div class="mt-3 space-y-2 text-sm text-slate-700">
                                            @php
                                                ...
                                                $experience = $cv && $cv->total_years_experience !== null ? number_format((float) $cv->total_years_experience, 1) . ' ans' : __('candidates.detail.not_available');
                                                $company = $cv && !empty($cv->experience_entries_json) ? ($cv->experience_entries_json[0]['company_name'] ?? __('candidates.detail.not_available')) : __('candidates.detail.not_available');
                                            @endphp
                                            ...
                                            <p><span class="font-semibold text-slate-900">Dernière Entreprise:</span> {{ $company }}</p>
                                            @if($parsedCvSummary)
