...
return [
    'title' => 'Pipeline',
    'subtitle' => 'Glissez les candidats entre étapes avec automatisations contrôlées.',
    ...
    'board' => [
        ...
        'vrin' => 'VRIN',
        'terminal_short' => 'T',
        'rejected_lane' => 'Rejeté',
    ],
    'pipeline' => [
        'misconfigured_title' => 'Pipeline mal configuré',
        'misconfigured_subtitle' => 'Le Kanban est bloqué tant que le pipeline du poste n\'est pas corrigé.',
        ...
        'errors' => [
            'no_stages' => 'Aucune étape de pipeline n\'est configurée pour ce poste.',
    ...
    'modal' => [
        ...
        'rejected_title' => 'Préparer brouillon de rejet',
    ...
    'flash' => [
        'stage_updated' => 'Transition d\'étape terminée.',
    ],
    'errors' => [
        'invalid_drop' => 'Cible de glisser invalide. Carte restaurée.',
        'same_stage' => 'Ce candidat se trouve déjà dans cette colonne.',
        'cancelled_move' => 'Transition annulée. Carte conservée dans l\'étape précédente.',
        'confirm_terminal_required' => 'Les étapes terminales exigent une confirmation.',
        'interview_schedule_required' => 'Planifier l\'entretien est requis avant le déplacement.',
        'rejection_reason_required' => 'La raison du rejet est requise.',
        'pipeline_misconfigured' => 'Le Kanban est bloqué car le pipeline de ce poste est mal configuré.',
    ],
    'default_channel' => 'Appel vidéo',
    'tasks' => [
        'interview_prep' => 'Préparer le dossier entretien',
    ],
    'rejection' => [
    ...
    'mail' => [
        ...
        'interview_line' => 'Votre entretien pour :job est confirmé le :datetime via :channel.',
